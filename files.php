...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<button class="btn btn-info btn-sm ml-4" id="new_file"><i class="fa fa-plus"></i> New File</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card-body">
					<table width="100%">
						<tr>
							...
							<th width="15%" class="">Date Received</th>
							<th width="20%" class="">Filename</th>
							<th width="20%" class="">Subject</th>
							<th width="10%" class="">Author</th>
							<th width="10%" class="">Handler</th>
							<th width="10%" class="">Status</th>
							<th width="10%" class="">Doc Type</th>
						</tr>
						<?php 
					...
					?>
						<tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
							...
							<td><i class="to_file"><?php echo $row['date_received'] ?></i></td>
							<!-- <td><i class="to_file"><?php //echo date('Y/m/d h:i A',strtotime($row['date_received'])) ?></i></td> -->
							<td><large><span><i class="fa <?php echo $icon ?>"></i></span><b class="to_file"> <?php echo $name ?></b></large>
							<input type="text" class="rename_file" value="<?php echo $row['name'] ?>" data-id="<?php echo $row['id'] ?>" data-type="<?php echo $row['file_type'] ?>" style="display: none">
							</td>
							<td><i class="to_file"><?php echo $row['subject'] ?></i></td>
							<td><i class="to_file"><?php echo $row['author'] ?></i></td>
							<td><i class="to_file"><?php echo $row['handler'] ?></i></td>
							<td><i class="to_file"><?php echo $row['status'] ?></i></td>
							<td><i class="to_file"><?php echo $row['doc_type'] ?></i></td>
