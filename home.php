...
<div class="containe-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card col-md-4 offset-2 bg-warning float-left" style="max-width: 12rem;">
			...
			<div class="card col-md-4 offset-2 bg-success ml-4 float-left" style="max-width: 12rem;">
			...
			<div class="card col-md-4 offset-2 bg-info ml-4 float-left" style="max-width: 12rem;">
				<div class="card-body text-white">
					<h4><b>Received</b></h4>
					<hr>
					<span class="card-icon"><i class="fa fa-folder-plus"></i></span>
					<h3 class="text-right"><b><?php echo $conn->query('SELECT * FROM files WHERE status = "Received"')->num_rows ?></b></h3>
				</div>
			</div>
			<div class="card col-md-4 offset-2 bg-warning ml-4 float-left" style="max-width: 12rem;">
				<div class="card-body text-dark">
					<h4><b>Pending</b></h4>
					<hr>
					<span class="card-icon"><i class="fa fa-folder-open"></i></span>
					<h3 class="text-right"><b><?php echo $conn->query('SELECT * FROM files WHERE status = "Pending"')->num_rows ?></b></h3>
				</div>
			</div> 
		</div>
	</div>
				...
				<div class="card-body">
					...
					?>
						<tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
							...
							<td><i><?php echo $row['subject'] ?></i></td>
						</tr>
